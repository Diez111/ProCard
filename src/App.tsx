...
export default function App() {
  ...
  const columns = useBoardStore(
    (state) => state.boards[selectedDashboard]?.columns || [],
  );
  ...
  const [isGoogleCalendarSectionOpen, setIsGoogleCalendarSectionOpen] =
    React.useState(true);
  ...
  }, [darkMode, googleCalendarUrl, setGoogleCalendarUrl]);
          ...
          <div className="max-w-[2000px] mx-auto px-4 py-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleExport} className="px-3 py-1">
                  Exportar
                </Button>
              ...
              >
                <div className="flex gap-4 h-full min-w-fit pb-4">
                  {columns.map((column, index) => (
                    <div
                      key={column.id}
                      className="flex-shrink-0 w-[85vw] md:w-72"
                    >
                      <Column
                        column={column}
              ...
              <div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg h-full flex flex-col space-y-6 overflow-y-auto scrollbar-custom">
                <div>
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      setIsWeatherSectionOpen(!isWeatherSectionOpen)
                    }
                  >
                  ...
                  {isWeatherSectionOpen && <TimeProgress />}
                </div>
                ...
                <div className="flex-1 flex flex-col min-h-0">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      setIsGoogleCalendarSectionOpen(
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="space-y-2">
                            <Label htmlFor="calendar-url">
                              ID del calendario o URL pública
                            </Label>
                            <Input
                              id="calendar-url"
                              type="text"
                              ...
                              onChange={(e) =>
                                setNewCalendarUrl(e.target.value)
                              }
                            />
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                              Para añadir su calendario: 1) Haga público el
                              calendario en la configuración 2) Copie el ID del
                              calendario o la URL de 'Integrar calendario'
                            </p>
                          </div>
                          <Button
                            onClick={() =>
                              handleGoogleCalendarUrl(newCalendarUrl)
                            }
                            className="w-full"
                          >
                            Añadir Calendar
